# Generated by Django 4.0.3 on 2022-04-09 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=20, unique=True, verbose_name='Название категории')),
                ('slug', models.SlugField(max_length=20, unique=True, verbose_name='URL')),
                ('image', models.ImageField(upload_to='shop', verbose_name='Картинка')),
            ],
        ),
        migrations.CreateModel(
            name='Cycle',
